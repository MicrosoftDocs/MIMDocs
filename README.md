...
You've found the GitHub repository that houses the source for the Microsoft Identity Manager (MIM) documentation, published to the Microsoft Enterprise Mobility (EM) Documentation Center at [https://docs.microsoft.com/en-us/enterprise-mobility/](https://docs.microsoft.com/en-us/enterprise-mobility/).

## Contribute to the Microsoft Identity Manager documentation
...
* Participation in a [Microsoft forum](https://social.technet.microsoft.com/Forums/en-US/home?category=identitymanagement) or [Stack Overflow](http://stackoverflow.com/search?q=Microsoft+Identity+Manager) discussion.
...
The main articles directory is found directly off the root of the repository, and contains a set of subdirectories with articles formatted as markdown files with an *.md* extension. For the MIM repository, this is the `\MIMDocs` subdirectory. 
...
1.Clone the repository:  
    ...
    git clone https://github.com/Microsoft/MIMDocs.git
