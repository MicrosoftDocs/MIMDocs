...
5.  On “Configure main server connection page” check “Use different account for
    ...
    >[!NOTE]
    >When **Use Exchange Online** option is selected in order to enable processing of approval responses generated by MIM Outlook Add-On you need to set registry key HKLM\SYSTEM\CurrentControlSet\Services\FIMService\PollExchangeEnabled to 1 after installation.
