...
### [Install MIM: Service and Portal for Microsoft Entra ID P1 or P2 customers](install-mim-service-portal-azure-ad-premium.md)
### [Install MIM: Sync databases](install-mim-sync-ad-service.md)
## [Upgrade from FIM or MIM to MIM 2016 SP2](microsoft-identity-manager-2016-service-pack-2-upgrade-path.md)
...
## [Integrate with ADFS](mim-adfs-prepare-installation.md)
### [Prepare for ADFS Installation](mim-adfs-prepare-installation.md)
### [Install and Configure ADFS](mim-adfs-installation-configuration.md)
