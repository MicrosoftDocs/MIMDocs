...
### Deprecations of other Microsoft components impacting MIM
 ...
 - The Windows Azure AD Connector for FIM is deprecated, and the Azure AD internal interfaces used by that connector are being removed. Existing deployments should migrate to [Azure AD Connect](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect), Azure AD Connect Sync, or the [Microsoft Graph Connector](microsoft-identity-manager-2016-connector-graph.md), as described in [how to migrate from the FIM Connector](migrate-from-the-fim-connector-for-azure-active-directory.md).
