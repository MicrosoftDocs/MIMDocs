...
title: Privileged Access Management for Active Directory Domain Services | Microsoft Identity Manager
description:
keywords:
author: kgremban
manager: stevenpo
...
PAM is the on-premises Active Directory version of the Azure service [Privileged Identity Management](https://azure.microsoft.com/documentation/articles/active-directory-privileged-identity-management-configure/) (PIM).
