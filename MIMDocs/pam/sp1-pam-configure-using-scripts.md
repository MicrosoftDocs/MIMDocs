...
### Setup
The table below should help you know on which system you need to run the script and which account you need to use to run the scripts. More details are included in the sections that cover the relevant steps.
...
| PAMServer (or SQL Server)   |CORP Domain Admin   |  .\PAMDeployment.ps1 Select menu option 3 (SQL Server Setup)   |
