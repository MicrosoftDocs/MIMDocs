...
> [!NOTE]
> The [Azure AD provisioning](../azure/active-directory/app-provisioning/user-provisioning) service now provides a lightweight agent based solution for provisioning users into a SQL database, without a full MIM sync deployment. We recommend evaluating if it meets your needs. [Learn more](../azure/active-directory/app-provisioning/tutorial-ecma-sql-connector).
